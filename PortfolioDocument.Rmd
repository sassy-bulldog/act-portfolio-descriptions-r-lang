        ...
        c(
          as.list(
            if (min_commission == prov_commission && prov_commission == max_commission) {
              c(sprintf("Flat: %s", min_commission))
              ...
              c(
                ...
                sprintf(
                  "Scale of %s:1",
                  (
                    MaximumCedingCommission - MinimumCedingCommission
                  ) / (
                    MaximumCedingCommissionLLAERatio - MinimumCedingCommissionLLAERatio
                  )
                ),
              )
              ...
              c(
                ...
                sprintf("Provisional/Max: %s @ %s LR", ProvisionalCedingCommission, prov_lr),
                sprintf(
                  "Scale of %s:1",
                  (
                    MaximumCedingCommission - MinimumCedingCommission
              ...
              c(
                ...
                sprintf(
                  "Scale of %s:1",
                  (
                    ProvisionalCedingCommission - MinimumCedingCommission
                  ) / (
                    ProvisionalCedingCommissionLLAERatio - MinimumCedingCommissionLLAERatio
                  )
                ),
                sprintf(
                  "Max: %s @ %s LR",
                ...
                sprintf(
                  "Scale of %s:1",
                  (
                    MaximumCedingCommission - ProvisionalCedingCommission
                  ) / (
                    MaximumCedingCommissionLLAERatio - ProvisionalCedingCommissionLLAERatio
                  )
                ),
              )
            }
